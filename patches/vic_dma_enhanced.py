...
Experimental Badline and Sprite DMA Cycle-Stealing Model
...
if TYPE_CHECKING:
    from c64sid.sid.vic_ii import VicII
...
class VicDmaEnhanced:
    """Enhanced VIC-II DMA model with cycle-oriented stealing behavior.
